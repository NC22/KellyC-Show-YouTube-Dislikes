...
KellyShowRate.apiController['API_ID'] = {
     ...
     // default params for configurable by user options
     cfgDefault : {
         enabled : false, // is get data active by default
         syncData : true, // is send actions active by default
         ratioLikeColor : '#55caff', // optional custom colors
