...
function KellyShowRate(cfg) {
    ...
    */    
    ...
    function showRetryForm(el) {
        
           var html  = '<div class="' + handler.baseClass + '-note"><p>Data service is not responding.</p>';
               html += '<p><a href="#" class="' + handler.baseClass + '-retry">Try again</a> | <a href="#" class="' + handler.baseClass + '-download-log">Download log</a></p>';
               html += '<p>If after retry problem still exist<br>you can report problem to <b>torrenttvi@gmail.com</b> (attach downloaded log). Thank you</p></div>';
    ...
    function showTip(e, stick) { 
           ...
           if (notice == 'retry') showRetryForm(handler.tooltip.getContent()); 
