...
var KellyCOptions = new Object(); 
    ...
    KellyCOptions.reportIssue = 'htt' + 'ps://gith' + 'ub.com/NC22/KellyC-Return-YouTube-Dislikes/issues';
    ...
    KellyCOptions.saveDataSourcesForm = function(data) {
        ...
        for (var key in KellyStorage.apis) {  
            ...
            if (document.getElementById(key + '-ratioLoadingColor').value) {
                cfg.ratioLoadingColor = document.getElementById(key + '-ratioLoadingColor').value;
            }
    ...
    KellyCOptions.showTitle = function() {
        ...
        var handler = KellyCOptions;        
            ...
            handler.titleHtml += '<a class="' + handler.baseClass + '-report" href="' + KellyCOptions.reportIssue + '">' + handler.getLoc('support_link') + '</a>';
